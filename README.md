...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 10.744 s |
| Cache restore | 365 ms |
| Runtime pull | 18.216 s |
| Capability materialization | 10.148 s |
| Cache save | 815 ms |
| Validation + finishing | 694 ms |
| Snapshot preparation | 4 ms |
| **Total to prepared snapshot** | **41.066 s** |
