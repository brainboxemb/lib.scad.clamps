...
Migration 011 issue #36 is the current repository-infrastructure step. It adopts
`tool.git-project v0.2.14`, `tool.scad-project v0.15.11`, managed root launchers,
current self/reusable workflow naming and the shared numbered documentation
structure without changing clamp geometry or the public OpenSCAD/PythonSCAD APIs.
